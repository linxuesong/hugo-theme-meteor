...
!function(n, e) {
    ...
    function l(t) {
        try {
            var r = e.querySelectorAll("code.hljs");// 获取code标签中含有hljs的元素(遍历所有代码块)
            for (var l in r)
                r.hasOwnProperty(l) && i(r[l], t) // 依次调用i,o函数
        } catch (o) {
    ...
    var f = "hljs-ln"
      ...
      , j = "data-line-number"
      , L = /\r\n|\r|\n/g;
    n.hljs ? (n.hljs.initLineNumbersOnLoad = r, // 调用function r函数
