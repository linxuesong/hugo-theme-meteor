...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == '/imgs/theme/bg/little-monster.png') {
    ...
    } else if (bgurl == 'https://bing.img.run/rand.php') {
      mashiro_global.variables.skinSecter = true
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', '/imgs/theme/bg/sakura.png')
  changeBG('#gribs-bg', '/imgs/theme/bg/plaid.jpg')
  changeBG('#pixiv-bg', '/imgs/theme/bg/star.png')
  changeBG('#KAdots-bg', '/imgs/theme/bg/point.png')
  changeBG('#totem-bg', '/imgs/theme/bg/little-monster.png')
  changeBGnoTrans('#bing-bg', 'https://bing.img.run/rand.php')
